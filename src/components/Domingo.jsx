...
const Domingo = () => {
  ...
  const fetchAvailableParkings = async () => {
    try {
      const endpoints = [
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_DOMINGO&SECCION=E',
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_DOMINGO&SECCION=A',
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_DOMINGO&SECCION=V'
      ];
