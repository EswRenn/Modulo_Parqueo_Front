...
const Sabado = () => {
  ...
  const fetchAvailableParkings = async () => {
    try {
      const endpoints = [
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_SABADO&SECCION=E',
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_SABADO&SECCION=A',
        '/api/disponibilidad_parqueo?JOR_TIPO=COMPLETA_SABADO&SECCION=V'
      ];
