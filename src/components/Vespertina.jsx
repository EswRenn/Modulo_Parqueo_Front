...
const Vespertina = () => {
  ...
  const fetchAvailableParkings = async () => {
    try {
      const endpoints = [
        '/api/disponibilidad_parqueo?JOR_TIPO=VESPERTINA&SECCION=E',
        '/api/disponibilidad_parqueo?JOR_TIPO=VESPERTINA&SECCION=A',
        '/api/disponibilidad_parqueo?JOR_TIPO=VESPERTINA&SECCION=V'
      ];
